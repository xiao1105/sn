...
function() {
            ...
            },
            {
                ...
                value: function(e, t) {
                    ...
                    case "hls":
                        ...
                        if (i.p2pConfig || (i.p2pConfig = {}), i.p2pConfig.tag || (i.p2pConfig.tag = "p2p-dplayer"), window.Hls) if (Hls.isSupported()) {
                        ...
                        function() {
                            if (Hls.isSupported()) {
                                ...
                                t.attachMedia(e),
                                n.hlsjs = t,
                                n.setupP2PListeners(t)
                            } else n.notice("Error: Hls is not supported.")
                        });
                        break;
                    case "flv":
            ...
            },
            {
                ...
                value: function(e) {
                    ...
                    default)({
                        ...
                        this.on("canplay",
                        function() {
                            t.prevVideo && (t.template.videoWrap.removeChild(t.prevVideo), t.video.classList.add("dplayer-video-current"), n || t.video.play(), t.prevVideo = null, t.notice(t.tran("Switched to") + " " + t.quality.name + " " + t.tran("quality")), t.switchingQuality = !1, t.events.trigger("quality_end"))
                        })
                    }
                }
            },
            {
                key: "destroyPrevVideo",
                value: function() {
                    this.hlsjs && (this.hlsjs.p2pEngine.removeAllListeners(), this.hlsjs.destroy())
                }
            },
            {
                key: "notice",
    ...
    default = function(e) {
            ...
            {
                text: "鍏虫敞浣滆€�",
                link: "https://jq.qq.com/?_wv=1027&k=5D0l23A"
            }]),
            e
        }
    },
    ...
    function(e, t, n) {
        ...
        var i = {
            "zh-cn": {
                "Powered by P2P Engine": "閲囩敤P2P鍔犻€�",
                "Danmaku is loading": "寮瑰箷鍔犺浇涓�",
                Top: "椤堕儴",
                Bottom: "搴曢儴",
                Rolling: "婊氬姩",
                "Input danmaku, hit Enter": "杈撳叆寮瑰箷锛屽洖杞﹀彂閫�",
                "DPlayer feedback": "鎾斁鍣ㄦ剰瑙佸弽棣�",
                "About DPlayer": "鍏充簬 DPlayer 鎾斁鍣�",
                Loop: "娲楄剳寰幆",
                Speed: "閫熷害",
                "Opacity for danmaku": "寮瑰箷閫忔槑搴�",
                Normal: "姝ｅ父",
                "Please input danmaku content!": "瑕佽緭鍏ュ脊骞曞唴瀹瑰晩鍠傦紒",
                "Set danmaku color": "璁剧疆寮瑰箷棰滆壊",
                "Set danmaku type": "璁剧疆寮瑰箷绫诲瀷",
                "Show danmaku": "鏄剧ず寮瑰箷",
                "Video load failed": "瑙嗛鍔犺浇澶辫触",
                "Danmaku load failed": "寮瑰箷鍔犺浇澶辫触",
                "Danmaku send failed": "寮瑰箷鍙戦€佸け璐�",
                "Switching to": "姝ｅ湪鍒囨崲鑷�",
                "Switched to": "宸茬粡鍒囨崲鑷�",
                quality: "鐢昏川",
                FF: "蹇繘",
                REW: "蹇€€",
                "Unlimited danmaku": "娴烽噺寮瑰箷",
                "Send danmaku": "鍙戦€佸脊骞�",
                Setting: "璁剧疆",
                "Full screen": "鍏ㄥ睆",
                "Web full screen": "椤甸潰鍏ㄥ睆",
                Send: "鍙戦€�",
                Screenshot: "鎴浘",
                s: "绉�",
                "Show subtitle": "鏄剧ず瀛楀箷",
                "Hide subtitle": "闅愯棌瀛楀箷",
                Volume: "闊抽噺",
                Live: "鐩存挱",
                "Video & P2P info": "瑙嗛缁熻淇℃伅"
            },
            "zh-tw": {
                "Powered by P2P Engine": "閲囩敤P2P鍔犻€�",
                "Danmaku is loading": "褰堝箷杓夊叆涓�",
                Top: "闋傞儴",
                Bottom: "搴曢儴",
                Rolling: "婊惧嫊",
                "Input danmaku, hit Enter": "杓稿叆褰堝箷锛孍nter 鐧奸€�",
                "About author": "闂滄柤浣滆€�",
                "DPlayer feedback": "鎾斁鍣ㄦ剰瑕嬪洖楗�",
                "About DPlayer": "闂滄柤 DPlayer 鎾斁鍣�",
                Loop: "寰挵鎾斁",
                Speed: "閫熷害",
                "Opacity for danmaku": "褰堝箷閫忔槑搴�",
                Normal: "姝ｅ父",
                "Please input danmaku content!": "璜嬭几鍏ュ綀骞曞収瀹瑰晩锛�",
                "Set danmaku color": "瑷畾褰堝箷椤忚壊",
                "Set danmaku type": "瑷畾褰堝箷椤炲瀷",
                "Show danmaku": "椤ず褰堝箷",
                "Video load failed": "褰辩墖杓夊叆澶辨晽",
                "Danmaku load failed": "褰堝箷杓夊叆澶辨晽",
                "Danmaku send failed": "褰堝箷鐧奸€佸け鏁�",
                "Switching to": "姝ｅ湪鍒囨彌鑷�",
                "Switched to": "宸茬稉鍒囨彌鑷�",
                quality: "鐣唱",
                FF: "蹇€�",
                REW: "蹇€€",
                "Unlimited danmaku": "宸ㄩ噺褰堝箷",
                "Send danmaku": "鐧奸€佸綀骞�",
                Setting: "瑷畾",
                "Full screen": "鍏ㄨ灑骞�",
                "Web full screen": "闋侀潰鍏ㄨ灑骞�",
                Send: "鐧奸€�",
                Screenshot: "鎴湒",
                s: "绉�",
                "Show subtitle": "椤ず瀛楀箷",
                "Hide subtitle": "闅辫棌瀛楀箷",
                Volume: "闊抽噺",
                Live: "鐩存挱",
                "Video & P2P info": "褰辩墖绲辫▓瑷婃伅"
            }
        };
        t.
    default = function(e) {
    ...
    function(e, t, n) {
        ...
        e.exports = function(e) {
            ...
            t += '">\n                <span class="dplayer-thumb" style="background: ',
            t += r(o.theme),
            t += '"></span>\n            </div>\n        </div>\n    </div>\n</div>\n<div class="dplayer-info-panel dplayer-info-panel-hide">\n    <div class="dplayer-info-panel-close">[x]</div>\n    <div class="dplayer-info-panel-item dplayer-info-panel-item-version">\n        <span class="dplayer-info-panel-item-title">鎾斁鍣ㄧ増鏈�</span>\n        <span class="dplayer-info-panel-item-data"></span>\n    </div>\n    <div class="dplayer-info-panel-item dplayer-info-panel-item-fps">\n        <span class="dplayer-info-panel-item-title">鎾斁甯х巼</span>\n        <span class="dplayer-info-panel-item-data"></span>\n    </div>\n    <div class="dplayer-info-panel-item dplayer-info-panel-item-type">\n        <span class="dplayer-info-panel-item-title">瑙嗛绫诲瀷</span>\n        <span class="dplayer-info-panel-item-data"></span>\n    </div>\n    <div class="dplayer-info-panel-item dplayer-info-panel-item-url">\n        <span class="dplayer-info-panel-item-title">瑙嗛閾炬帴</span>\n        <span class="dplayer-info-panel-item-data"></span>\n    </div>\n    <div class="dplayer-info-panel-item dplayer-info-panel-item-resolution">\n        <span class="dplayer-info-panel-item-title">瑙嗛鍒嗚鲸鐜�</span>\n        <span class="dplayer-info-panel-item-data"></span>\n    </div>\n    <div class="dplayer-info-panel-item dplayer-info-panel-item-duration">\n        <span class="dplayer-info-panel-item-title">瑙嗛鏃堕暱</span>\n        <span class="dplayer-info-panel-item-data"></span>\n    </div>\n    ',
            o.danmaku && (t += '\n    <div class="dplayer-info-panel-item dplayer-info-panel-item-danmaku-id">\n        <span class="dplayer-info-panel-item-title">寮瑰箷ID</span>\n        <span class="dplayer-info-panel-item-data"></span>\n    </div>\n    <div class="dplayer-info-panel-item dplayer-info-panel-item-danmaku-api">\n        <span class="dplayer-info-panel-item-title">寮瑰箷鎺ュ彛</span>\n        <span class="dplayer-info-panel-item-data"></span>\n    </div>\n    <div class="dplayer-info-panel-item dplayer-info-panel-item-danmaku-amount">\n        <span class="dplayer-info-panel-item-title">寮瑰箷鏁伴噺</span>\n        <span class="dplayer-info-panel-item-data"></span>\n    </div>\n    '),
            t += '\n    <div class="dplayer-info-panel-item dplayer-info-panel-item-p2p-version">\n        <span class="dplayer-info-panel-item-title">鍔犻€熷櫒鐗堟湰</span>\n        <span class="dplayer-info-panel-item-data"></span>\n    </div>\n    <div class="dplayer-info-panel-item dplayer-info-panel-item-p2p-downloaded">\n        <span class="dplayer-info-panel-item-title">P2P 涓嬭浇</span>\n        <span class="dplayer-info-panel-item-data"></span>\n    </div>\n    <div class="dplayer-info-panel-item dplayer-info-panel-item-p2p-uploaded">\n        <span class="dplayer-info-panel-item-title">P2P 涓婁紶</span>\n        <span class="dplayer-info-panel-item-data"></span>\n    </div>\n    <div class="dplayer-info-panel-item dplayer-info-panel-item-peerid">\n        <span class="dplayer-info-panel-item-title">瑙嗛ID</span>\n        <span class="dplayer-info-panel-item-data"></span>\n    </div>\n    <div class="dplayer-info-panel-item dplayer-info-panel-item-peers">\n        <span class="dplayer-info-panel-item-title">瀵圭瓑閾炬帴鏁伴噺</span>\n        <span class="dplayer-info-panel-item-data"></span>\n    </div>\n</div>\n<div class="dplayer-menu">\n    ',
            u(o.contextmenu,
            function(e, n) {
    ...
    function(e, t, n) {
        ...
        var a = function() {
            ...
            },
            {
                key: "update",
                value: function() {
                    this.template.infoVersion.innerHTML = "www.7kki.cn",
